...
// HealthExtractionJobModel mapeia a tabela health_extraction_jobs.
// A tabela NÃO possui deleted_at — sem soft delete.
type HealthExtractionJobModel struct {
	ID            uuid.UUID      `gorm:"type:uuid;primaryKey"`
	WorkspaceID   uuid.UUID      `gorm:"type:uuid;not null"`
	DocumentID    uuid.UUID      `gorm:"type:uuid;not null;index:idx_health_extraction_jobs_document"`
...
func (HealthExtractionJobModel) TableName() string { return "health_extraction_jobs" }
